        ...
        for event in pygame.event.get():
            if event.dict.get('key') == 27 :
                ...
                for i in range(random.randint(2,3)):
                    IntroBubble(random.choice(Balloon_tuple)[0], random.randint(50,width-100), height, random.randint(4,8))
    ...
    while not game_over:
        for event in pygame.event.get():
            if event.dict.get('key') == 27:
                ...
                for i in range(random.randint(2,3)):
                    MainWinBubble(random.choice(Balloon_tuple), random.randint(50,width-100), height, random.randint(8,12))
